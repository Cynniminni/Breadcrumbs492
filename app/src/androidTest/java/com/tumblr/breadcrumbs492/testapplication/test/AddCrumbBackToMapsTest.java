...
import com.tumblr.breadcrumbs492.testapplication.AddCrumbActivity;
 ...
 */
public class AddCrumbBackToMapsTest extends ActivityInstrumentationTestCase2<LoginActivity> {

    private Solo solo;

    public AddCrumbBackToMapsTest() {
    ...
    public void testRun() {
        ...
        assertTrue("com.tumblr.breadcrumbs492.testapplication.MapsActivity is not found!", solo.waitForActivity(AddCrumbActivity.class, 2000));
        // Log out
