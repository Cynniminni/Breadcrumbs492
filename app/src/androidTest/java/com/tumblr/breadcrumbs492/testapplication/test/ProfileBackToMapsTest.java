 ...
 */
public class ProfileBackToMapsTest extends ActivityInstrumentationTestCase2<LoginActivity> {

    private Solo solo;

    public ProfileBackToMapsTest() {
    ...
    public void testRun() {
        ...
        assertTrue("com.tumblr.breadcrumbs492.testapplication.MapsActivity is not found!", solo.waitForActivity(ProfileActivity.class, 2000));
        // Log out
