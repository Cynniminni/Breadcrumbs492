 ...
 */
public class CrumbRanksBackToMapsTest extends ActivityInstrumentationTestCase2<LoginActivity> {

    private Solo solo;

    public CrumbRanksBackToMapsTest() {
    ...
    public void testRun() {
        ...
        assertTrue("com.tumblr.breadcrumbs492.testapplication.MapsActivity is not found!", solo.waitForActivity(Rankings.class, 2000));
        // Log out
